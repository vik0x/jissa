	...
	@section('contenido')
		...
		<div class="panel panel-transparent">
	  		<div class="panel-body">
			    <form id="form-agregar" role="form" autocomplete="off" method="POST" action="{{url('/administrador/agregar/seccion.html')}}">
			    	{!!csrf_field()!!}
			      	...
			      	<div class="row">
			        	<div class="col-sm-12">
			          		<div class="form-group form-group-default">
			            		...
			            		<input type="number" id="orden" class="form-control" name="orden" aria-required="true" aria-invalid="true">
			          		</div>
			          	</div>
			      	</div>
